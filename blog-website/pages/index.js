...
export default function Home({ globalStyles }) {
  ...
  return (
    <Layout title="首页">
      <Row className={globalStyles.mainContent} type="flex" justify="center">
        <Col className={globalStyles.mainContentLeft} xs={0} sm={0} md={7} lg={5} xl={4}>
          <Affix offsetTop={5}>
            <Author globalStyles={globalStyles} />
          </Affix>
        </Col>
        <Col className={globalStyles.mainContentRight} xs={24} sm={24} md={16} lg={18} xl={14}>
          <div>
            <List
              itemLayout="vertical"
              dataSource={mylist}
